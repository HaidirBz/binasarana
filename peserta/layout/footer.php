...
<footer class="main-footer">
  ...
  <?php
    $sql = mysqli_query($connect, "select * from admin order by admin_id desc");
    while ($data= mysqli_fetch_array($sql)){ 
  ?>
    <strong><font color="red">Hub Contact Admin <?php echo $data['no_hp']; ?></font></strong>
  <?php
  }
  ?> 

  || <strong>Copyright &copy; 2019 Bina Sarana Mandiri.</a> All rights.</strong>
