...
$flexitheme->options['widgets_options']['tabs'] = array_key_exists('tabs', $flexitheme->options['widgets_options'])
    ?  array_merge($themater_tabs_defaults, $flexitheme->options['widgets_options']['tabs'])
...
class ThematerTabs extends WP_Widget 
{
    ...
    function __construct() 
    {
        ...
        $this->defaults = $flexitheme->options['widgets_options']['tabs'];
        
        $this->posts_defaults = $flexitheme->options['widgets_options']['posts'];
        
        $this->comments_defaults = $flexitheme->options['widgets_options']['comments'];
    ...
    function widget($args, $instance)
    {
       global $flexitheme;
       extract( $args );
       $instance = ! empty( $instance ) ? $instance : $flexitheme->options['widgets_options']['tabs'];
                                    ...
                                    if($this->posts_defaults['display_date'] || $this->posts_defaults['display_author']) {
                                        ?><div class="posts-widget-meta"><?php 
                                            if($this->posts_defaults['display_date'] ) {
                                                the_time($flexitheme->get_option('dateformat'));
                                            }
                                    ...
                                    if($this->posts_defaults['display_content'] || $this->posts_defaults['display_read_more']) {
                                        ?><div class="posts-widget-entry"><?php 
                                            if($this->posts_defaults['content_type'] == 'the_content') {
                                                ...
                                                echo $flexitheme->shorten(get_the_excerpt(), $get_the_excerpt_length);
                                            }
                                    ...
                                    if($this->comments_defaults['display_comment'] || $this->comments_defaults['display_read_more'] || $this->comments_defaults['display_avatar']) { ?> 
                                        ...
                                        <?php 
                                            ...
                                            if($this->comments_defaults['display_comment']) { 
                                                ...
                                                echo $flexitheme->shorten(strip_tags($comment->com_excerpt), $get_the_comment_length); 
                                            }
