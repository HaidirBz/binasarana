...
$flexitheme->options['widgets_options']['banners125'] = array_key_exists('banners125', $flexitheme->options['widgets_options'])
    ? array_merge($themater_banners_125_defaults, $flexitheme->options['widgets_options']['banners125'])
...
class ThematerBanners125 extends WP_Widget 
{
    ...
    function widget($args, $instance)
    {
        global $flexitheme;
        extract( $args );
        $instance = ! empty( $instance ) ? $instance : $flexitheme->options['widgets_options']['banners125'];
    ...
    {	
        global $flexitheme;
		$instance = wp_parse_args( (array) $instance, $flexitheme->options['widgets_options']['banners125'] );
        $get_banners = $instance['banners'];
        ?>
