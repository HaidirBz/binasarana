...
$flexitheme->options['widgets_options']['infobox'] = array_key_exists('infobox', $flexitheme->options['widgets_options'])
    ? array_merge($themater_infobox_defaults, $flexitheme->options['widgets_options']['infobox'])
...
class ThematerInfoBox extends WP_Widget 
{
    ...
    function widget($args, $instance)
    {
        global $flexitheme;
        extract( $args );
        $instance = ! empty( $instance ) ? $instance : $flexitheme->options['widgets_options']['infobox'];
    ...
    {	
        global $flexitheme;
		$instance = wp_parse_args( (array) $instance, $flexitheme->options['widgets_options']['infobox'] );
