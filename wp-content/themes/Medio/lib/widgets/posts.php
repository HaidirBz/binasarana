...
$flexitheme->options['widgets_options']['posts'] = array_key_exists('posts', $flexitheme->options['widgets_options'])
    ? array_merge($themater_posts_defaults, $flexitheme->options['widgets_options']['posts'])
...
class ThematerPosts extends WP_Widget 
{
    ...
    function widget($args, $instance)
    {
        global $flexitheme;
        extract( $args );
        $instance = ! empty( $instance ) ? $instance : $flexitheme->options['widgets_options']['posts'];
        ...
        <ul class="widget-container"><li class="posts-widget">
        	...
        	<?php
                ...
                if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                    <li class="clearfix">
                        <?php if ($flexitheme->options['general']['featured_image'] && $instance['display_featured_image'] && has_post_thumbnail() ) { ?><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail(array($instance['featured_image_width'],$instance['featured_image_height']), array("class" => "posts-widget-featured-image " . $instance['featured_image_align'])); ?></a> <?php } ?>
    ...
    {	
        global $flexitheme;
		$instance = wp_parse_args( (array) $instance, $flexitheme->options['widgets_options']['posts'] );
