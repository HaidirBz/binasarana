<?php
    ...
    $themater_social_profiles_defaults = array(
        ...
        'profiles' => array(
            ...
            array('title' => 'RSS Feed', 'url' => $flexitheme->rss_url(), 'button' => get_template_directory_uri() . '/images/social-profiles/rss.png'),
            array('title' => 'Email', 'url' => 'mailto:your@email.com', 'button' => get_template_directory_uri() . '/images/social-profiles/email.png')
        )
    );
    
    $flexitheme->options['widgets_options']['socialprofiles'] = array_key_exists('socialprofiles', $flexitheme->options['widgets_options'])
    ? array_merge($themater_social_profiles_defaults, $flexitheme->options['widgets_options']['socialprofiles'])
...
class ThematerSocialProfiles extends WP_Widget 
{
    ...
    function widget($args, $instance)
    {
        global $flexitheme;
        extract( $args );
        $instance = ! empty( $instance ) ? $instance : $flexitheme->options['widgets_options']['socialprofiles'];
    ...
    {	
        global $flexitheme;
        $instance = wp_parse_args( (array) $instance, $flexitheme->options['widgets_options']['socialprofiles'] );
