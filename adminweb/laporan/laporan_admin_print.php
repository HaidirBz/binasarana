...
$query = "SELECT a.username, b.nama_lengkap FROM user a INNER JOIN admin b ON (a.user_id=b.user_id) ORDER BY b.nama_lengkap";
...
while($data=mysqli_fetch_array($sql)){
	...
	$pdf->cell($header[1],($line * $cellHeight),$data["nama_lengkap"],1,'0',$fill);
...
$pdf->SetY(-32);
#output file PDF
$pdf->output("BSM-data-admin-($tgl).pdf","I");
