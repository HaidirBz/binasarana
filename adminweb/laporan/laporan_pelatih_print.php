...
$query = "SELECT a.username, b.nama_pelatih, b.jk, b.email, b.no_hp FROM user a INNER JOIN pelatih b ON (a.user_id=b.user_id) ORDER BY b.nama_pelatih";

$judul="LAPORAN DATA PELATIH";
$no = 0;
...
while($data=mysqli_fetch_array($sql)){
	...
	$pdf->cell($header[1],($line * $cellHeight),$data["nama_pelatih"],1,'0',$fill);
...
$pdf->SetY(-32);
#output file PDF
$pdf->output("BSM-data-pelatih-($tgl).pdf","I");
